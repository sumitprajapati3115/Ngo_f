import { J as isNumber } from "./browser-D9dcGsUv.js";
import { t as Emitter } from "./Emitter-DaEk2Kei.js";
//#region node_modules/@tsparticles/plugin-emitters/browser/EmittersInstancesManager.js
var defaultIndex = 0;
var EmittersInstancesManager = class {
	...
	async addEmitter(container, options, position) {
		...
		const { EmitterInstance } = await import("./EmitterInstance-Jjx6Zbva.js"), emitter = new EmitterInstance(this.#pluginManager, container, (emitter) => {
